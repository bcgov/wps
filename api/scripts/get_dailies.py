...
to retrieve daily weather data (in CSV format) for all 277 weather stations,
1 station at a time, for April 1 - September 30 for
years 2011 - 2020.
"""
import requests
import re
...
for code in codes:
    ...
    if csv_path is not None:
        ...
        filename = os.path.join('/Users/awilliam/Desktop/wps/api/sourceData/dailies/',
                                csv_path.group(0)[-24:])
