...
def upgrade():
    ...
    op.create_index(
        op.f("ix_processed_model_run_files_id"), "processed_model_run_files", ["id"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_prediction_model_runs_id"), "prediction_model_runs", ["id"], unique=False
    )
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "prediction_model_run_id", "prediction_model_grid_subset_id", "prediction_timestamp"
        ),
...
def downgrade():
    ...
    op.drop_index(op.f("ix_prediction_model_runs_id"), table_name="prediction_model_runs")
    ...
    op.drop_index(op.f("ix_processed_model_run_files_id"), table_name="processed_model_run_files")
