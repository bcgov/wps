...
def insert_green_lake_station(session: Session, fuel_type_id: int, planning_area_id: int, station_code: int, order_of_appearance_in_planning_area_list: int):
...
def upgrade():
    ...
    wet_belt_update_order_stmt = planning_areas_table.update().\
    ...
    green_lake_insert_stmt = planning_areas_table.insert().values({
        'name': green_lake_name,
        'fire_centre_id': cafc_id,
        'order_of_appearance_in_list': 4
