...
def upgrade():
    ...
    sa.Column('fuel_type', sa.Enum('C1', 'C2', 'C3', 'C4', 'C5', 'C6', 'C7', 'C7B', 'D1', 'D2', 'M1', 'M2', 'M3', 'M4', 'O1A', 'O1B', 'S1', 'S2', 'S3', name='fueltypeenum'), nullable=False),
    ...
    op.create_index('idx_fire_watch_burn_location', 'fire_watch', ['burn_location'], unique=False, postgresql_using='gist')
