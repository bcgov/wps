...
def upgrade():
    ...
    op.create_table('advisory_shapes',
                    ...
                    sa.PrimaryKeyConstraint('id'),
                    sa.UniqueConstraint('external_identifier', 'shape_type'),
    ...
    op.create_index(op.f('ix_advisory_shapes_external_identifier'),
                    'advisory_shapes', ['external_identifier'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic! ###
    op.drop_index(op.f('ix_advisory_shapes_external_identifier'), table_name='advisory_shapes')
