...
def upgrade():
    ...
    op.create_index(op.f('ix_mat_view_prediction_timestamp'), 'mat_view', ['prediction_timestamp'], unique=False)
    op.create_index(op.f('ix_mat_view_station_code'), 'mat_view', ['station_code'], unique=False)


def downgrade():
    op.drop_index(op.f('ix_mat_view_prediction_timestamp'), table_name='mat_view')
    op.drop_index(op.f('ix_mat_view_station_code'), table_name='mat_view')
    op.execute('DROP MATERIALIZED VIEW mat_view')
