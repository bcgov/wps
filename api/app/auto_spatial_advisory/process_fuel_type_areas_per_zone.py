...
def calculate_fuel_type_areas_per_zone(zones, fuel_type_lookup: Dict[int, int]):
    """
    ...
    for zone in zones:
        ...
        for fuel_type_area in fuel_type_area_data:
            yield (fuel_type_area[0], fuel_type_lookup[fuel_type_area[1]], fuel_type_area[2])
    fuel_raster_ds = None