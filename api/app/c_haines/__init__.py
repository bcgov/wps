...
class GDALData():
    ...
    def __init__(self, grib_tmp_700: gdal.Dataset, grib_tmp_850: gdal.Dataset, grib_dew_850: gdal.Dataset, grib_tmp_700_filename: str):
        ...
        self.grib_tmp_700_filename: str = grib_tmp_700_filename
