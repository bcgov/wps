Feature: Grib file processing
    ...
    Scenario: Calculate raster coordinates
        ...
        Examples:
            ...
            | (-180.075, 0.15000000000000002, 0.0, 90.075, 0.0, -0.15)            | CMC_glb_latlon.15x.15_projection_wkt.txt         | (-120.4816667, 50.6733333) | (262, 397)        |
            | (-180.075, 0.15000000000000002, 0.0, 90.075, 0.0, -0.15)            | CMC_glb_latlon.15x.15_projection_wkt.txt         | (-116.7464000, 49.4358000) | (270, 422)        |
            | (-180.075, 0.15000000000000002, 0.0, 90.075, 0.0, -0.15)            | CMC_glb_latlon.15x.15_projection_wkt.txt         | (-123.2732667, 52.0837700) | (253, 378)        |
    ...
    Scenario: Calculate geographic coordinates
        ...
        Examples:
            ...
            | (-180.075, 0.15000000000000002, 0.0, 90.075, 0.0, -0.15)            | CMC_glb_latlon.15x.15_projection_wkt.txt         | (330, 370)        | (-124.57499999999999, 40.575)             | 
            | (-180.075, 0.15000000000000002, 0.0, 90.075, 0.0, -0.15)            | CMC_glb_latlon.15x.15_projection_wkt.txt         | (455, 315)        | (-132.825, 21.825000000000003)            | 
            | (-180.075, 0.15000000000000002, 0.0, 90.075, 0.0, -0.15)            | CMC_glb_latlon.15x.15_projection_wkt.txt         | (245, 427)        | (-116.02499999999998, 53.325)             | 
