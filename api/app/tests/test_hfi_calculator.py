...
# def assert_individual_station_data(response, temperature, relative_humidity, wind_direction, wind_speed, precipitation, grass_cure_percentage, ffmc, dc, isi, bui, fwi, danger_cl, fbp_fuel_type):
