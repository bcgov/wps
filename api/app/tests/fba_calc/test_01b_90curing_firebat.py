...
async def test_01b_90curing_request_response(anyio_backend, async_client: AsyncClient, monkeypatch: pytest.MonkeyPatch):
        ...
        "stations": [
            {
                ...
                "head_fire_intensity": 2974.02,
                "rate_of_spread": 28.324,
                "fire_type": "SUR",
                "percentage_crown_fraction_burned": 0.0,
                "flame_length": 3.149,
                "sixty_minute_fire_size": 84.12,
                "thirty_minute_fire_size": 15.194,
