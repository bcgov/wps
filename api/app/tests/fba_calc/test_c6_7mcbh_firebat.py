...
async def test_c6_7mcbh_request_response(anyio_backend, async_client: AsyncClient, monkeypatch: pytest.MonkeyPatch):
        ...
        "stations": [
            {
                ...
                "head_fire_intensity": 2821.875,
                "rate_of_spread": 3.01,
                "fire_type": "SUR",
                "percentage_crown_fraction_burned": 0.0,
                "flame_length": 3.067,
                "sixty_minute_fire_size": 1.62,
                "thirty_minute_fire_size": 0.289,
