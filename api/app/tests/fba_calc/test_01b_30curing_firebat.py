...
async def test_01b_30curing_request_response(anyio_backend, async_client: AsyncClient, monkeypatch: pytest.MonkeyPatch):
        ...
        "stations": [
            {
                ...
                "head_fire_intensity": 97.335,
                "rate_of_spread": 0.927,
                "fire_type": "SUR",
                "percentage_crown_fraction_burned": 0.0,
                "flame_length": 0.57,
                "sixty_minute_fire_size": 0.09,
                "thirty_minute_fire_size": 0.016,
