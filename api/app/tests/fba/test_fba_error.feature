Feature: /fbc/
    ...
    Scenario: Fire Behaviour Calculation
        ...
        Examples:
            ...
            | 780       | 50.6733333 | -120.4816667 | 2021-07-12       | 6.2        | 3              | 100                | None                       | None       | 2                 | C2        | 11.5 | 186.8 | 94.8 | 126.1 | 900.3 | 0.002                | 0.001                    | 19.26           | 30072.67        | 1.0             |
# | 780       | 50.6733333 | -120.4816667 | 2021-07-12       | 6.2        | 3              | 100                | None                       | None       | 2                 | C3        | 11.5 | 186.8 | 94.8 | 126.1 | 900.3 | 0.07                 | 0.18                     | 8.21            | 13097.75        | 0.7             |
