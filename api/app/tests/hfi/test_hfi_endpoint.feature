Feature: /hfi/
    ...
    Scenario: HFI - load request, no request stored
        ...
        Examples:
            ...
            | test_hfi_endpoint_request_load_no_date_specified.json | 200         | test_hfi_endpoint_response_request_not_loaded.json | False         |
            # the request doesn't contain a valid prep date, so it's not going to be saved.
            | test_hfi_endpoint_request_save_invalid.json           | 200         | test_hfi_endpoint_response_request_save.json       | False         |
            # this request has a valid prep date, so we expect it to be saved.
            | test_hfi_endpoint_request_save_valid.json             | 200         | test_hfi_endpoint_response_request_save.json       | True          |
    ...
    Scenario: HFI - load request, request stored
        ...
        Examples:
            ...
            | test_hfi_endpoint_request_load_no_date_specified.json | 200         | test_hfi_endpoint_response_request_loaded.json | stored_request.json |