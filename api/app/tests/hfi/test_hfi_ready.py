...
import app
import json
from wps_shared.db.models.hfi_calc import HFIRequest, HFIReady
...
post_toggle_ready_state_url = '/api/hfi-calc/fire_centre/5/planning_area/1/2022-05-01/2022-05-01/ready'
