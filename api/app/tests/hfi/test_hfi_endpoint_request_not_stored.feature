Feature: /hfi/
    ...
    Scenario: HFI - load request, no request stored
        ...
        Examples:
            ...
            | test_hfi_endpoint_request_save_invalid.json           | 200         | test_hfi_endpoint_response_save_invalid.json  | False         |
            # this request has a valid prep date, so we expect it to be saved.
            | test_hfi_endpoint_request_save_valid.json             | 200         | test_hfi_endpoint_response_save_true.json     | True          |
            | test_hfi_endpoint_request_save_valid_239.json         | 200         | test_hfi_endpoint_response_save_true_239.json | True          |
