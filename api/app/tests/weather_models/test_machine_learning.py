...
from wps_jobs.wps_jobs.weather_model_jobs.machine_learning import StationMachineLearning
import math
...
def test_bias_adjustment_of_rh_above_100(monkeypatch,                                         
                                         mock_get_accumulated_precip_by_24h_interval,
                                         mock_get_predicted_daily_precip):
    ...
    def get_actuals_and_predictions_with_high_rh(*args):
        ...
        return [
            [HourlyActual(weather_date=datetime(2020, 10, 10, 18),
                          ...
                          rh_valid=True),
            ModelRunPrediction(tmp_tgl_2=2,
                               rh_tgl_2=105,
                               apcp_sfc_0=2,
                               wind_tgl_10=11,
                               wdir_tgl_10=97,
            ...
            [HourlyActual(weather_date=datetime(2020, 10, 10, 21),
                          ...
                          relative_humidity=105,
                          rh_valid=True),
            ModelRunPrediction(tmp_tgl_2=1,
                               rh_tgl_2=105,
                               apcp_sfc_0=3,
                               wind_tgl_10=11,
                               wdir_tgl_10=101,
