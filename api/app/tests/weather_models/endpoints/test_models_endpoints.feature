Feature: Generic model endpoint testing
    ...
    Scenario: Generic model endpoint testing
        ...
        Examples:
            ...
            | [838]      | /api/models/GDPS/predictions/most_recent/ | test_models_predictions_most_recent_gdps_838_db.json         | get_station_model_predictions                               | app.weather_models.fetch.predictions | 200                  | test_models_predictions_most_recent_gdps_838_response.json |
