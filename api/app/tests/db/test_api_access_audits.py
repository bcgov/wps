...
from common.db.crud.api_access_audits import create_api_access_audit_log


class TestApiAccessAudit(unittest.TestCase):
    """ Access audit test cases """

    @patch("common.db.database._get_write_session", return_value=MagicMock())
    @patch("common.db.crud.api_access_audits.logger")
