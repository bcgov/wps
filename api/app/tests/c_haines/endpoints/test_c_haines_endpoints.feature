Feature: C-Haines endpoint testing
    ...
    Scenario: C-Haines endpoint testing
        ...
        Examples:
            ...
            | /api/c-haines/GDPS/prediction?model_run_timestamp=2021-03-08T12%3A00%3A00&prediction_timestamp=2021-03-08T12%3A00%3A00&response_format=JSON | 307         |                                                   |
            ...
            | /api/c-haines/GDPS/predictions?response_format=JSON                                                                                         | 501         |                                                   |
