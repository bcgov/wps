Feature: C-Haines calculation
    ...
    Scenario: Re-project
        Given <input_geojson> with <source_projection> and <expected_output_geojson>
        Then Compare expected geojson with actual

        Examples:
            | input_geojson                   | expected_output_geojson                   | source_projection                                                                                                                                                                                                                                                                                                                                                                                                                   |
            | test_re_project_gdps_input.json | test_re_project_gdps_expected_output.json | GEOGCS["Coordinate System imported from GRIB file",DATUM["unnamed",SPHEROID["Sphere",6371229,0]],PRIMEM["Greenwich",0],UNIT["degree",0.0174532925199433,AUTHORITY["EPSG","9122"]],AXIS["Latitude",NORTH],AXIS["Longitude",EAST]]                                                                                                                                                                                                    |
            | test_re_project_rdps_input.json | test_re_project_rdps_expected_output.json | PROJCS["unnamed",GEOGCS["Coordinate System imported from GRIB file",DATUM["unnamed",SPHEROID["Sphere",6371229,0]],PRIMEM["Greenwich",0],UNIT["degree",0.0174532925199433,AUTHORITY["EPSG","9122"]]],PROJECTION["Polar_Stereographic"],PARAMETER["latitude_of_origin",60],PARAMETER["central_meridian",249],PARAMETER["false_easting",0],PARAMETER["false_northing",0],UNIT["Metre",1],AXIS["Easting",SOUTH],AXIS["Northing",SOUTH]] |
