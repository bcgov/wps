...
def test_critical_hours_10000_high_rh():
    ...
    crit_hours_4000 = get_critical_hours(target_hfi=10000,
                                         ...
                                         prev_daily_ffmc=94.561,
                                         last_observed_morning_rh_values={7.0: 88.0, 8.0: 88.0, 9.0: 88.0, 10.0: 88.0, 11.0: 88.0, 12.0: 88.0})
    assert crit_hours_4000 == CriticalHoursHFI(start=13.00, end=15.00)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (90, 90, {7.0: 54.0, 8.0: 47.0, 9.0: 46.0, 10.0: 45.0, 11.0: 44.0, 12.0: 38.0}, 11.00, 15.00),
        # high daily ffmc, high previous daily ffmc, high range rh values
        (90, 90, {7.0: 88.0, 8.0: 88.0, 9.0: 88.0, 10.0: 88.0, 11.0: 88.0, 12.0: 88.0}, 12.00, 15.00),

        # higher daily ffmc, higher previous daily ffmc, mid range rh values
        (92, 92, {7.0: 54.0, 8.0: 47.0, 9.0: 46.0, 10.0: 45.0, 11.0: 44.0, 12.0: 38.0}, 9.00, 15.00),
        # higher daily ffmc, higher previous daily ffmc, high range rh values
        (92, 92, {7.0: 88.0, 8.0: 88.0, 9.0: 88.0, 10.0: 88.0, 11.0: 88.0, 12.0: 88.0}, 12.00, 15.00),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # higher daily ffmc, higher previous daily ffmc, mid range rh values
        (92, 92, {7.0: 54.0, 8.0: 47.0, 9.0: 46.0, 10.0: 45.0, 11.0: 44.0, 12.0: 38.0}, 12.00, 15.00),
        # higher daily ffmc, higher previous daily ffmc, high range rh values
        (92, 92, {7.0: 88.0, 8.0: 88.0, 9.0: 88.0, 10.0: 88.0, 11.0: 88.0, 12.0: 88.0}, 13.00, 15.00),
