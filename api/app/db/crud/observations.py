...
from app.db.models.weather_models import (ModelRunPrediction, PredictionModel,
                                          PredictionModelRunTimestamp, WeatherStationModelPrediction)
...
def get_accumulated_precip_by_24h_interval(session: Session, station_code: int, start_datetime: datetime, end_datetime: datetime):
    """ Get the accumulated precip for 24 hour intervals for a given station code within the specified interval.
    :param session: The ORM/database session.
    :param station_code: The code identifying the weather station of interest.
    :param start_datetime: The earliest date and time of interest.
    :param end_datetime: The latest date and time of interest.
    """
    # Note: I couldn't construct this query in SQLAlchemy
    stmt = """
