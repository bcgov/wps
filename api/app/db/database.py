...
_async_read_engine = create_async_engine(ASYNC_DB_READ_STRING, connect_args={"server_settings": {"search_path": "public"}, "timeout": 30})
_async_write_engine = create_async_engine(ASYNC_DB_WRITE_STRING, connect_args={"server_settings": {"search_path": "public"}, "timeout": 30})
