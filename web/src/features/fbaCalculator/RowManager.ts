...
export class RowManager {
  ...
  public static exportRowsAsStrings = (tableRows: FBATableRow[]): string[][] => {
    ...
    tableRows.forEach((value) => {
      ...
      rowString.push(isNull(value.weatherStation) || isUndefined(value.weatherStation.label) ? '' : value.weatherStation.label)
      ...
      rowString.push(isUndefined(value.grass_cure) || isNaN(value.grass_cure) || isNull(value.grass_cure) ? '' : value.grass_cure.toString())
      ...
      rowString.push(isUndefined(value.wind_direction) || isNaN(value.wind_direction) || isNull(value.wind_direction) ? '' : value.wind_direction.toString())
      ...
      rowString.push(isUndefined(value.precipitation) ? '' : value.precipitation.toString())
      rowString.push(isUndefined(value.fine_fuel_moisture_code) ? '' : value.fine_fuel_moisture_code.toString())
      rowString.push(isUndefined(value.duff_moisture_code) ? '' : value.duff_moisture_code.toString())
      rowString.push(isUndefined(value.drought_code) ? '' : value.drought_code.toString())
      rowString.push(isUndefined(value.initial_spread_index) ? '' : value.initial_spread_index.toString())
      rowString.push(isUndefined(value.build_up_index) ? '' : value.build_up_index.toString())
      rowString.push(isUndefined(value.fire_weather_index) ? '' : value.fire_weather_index.toString())
      rowString.push(isUndefined(value.head_fire_intensity) ? '' : value.head_fire_intensity.toString())
      ...
      rowString.push(isUndefined(value.rate_of_spread) ? '' : value.rate_of_spread.toString())
      ...
      rowString.push(isUndefined(value.thirty_minute_fire_size) ? '' : value.thirty_minute_fire_size.toString())
      rowString.push(isUndefined(value.sixty_minute_fire_size)? '' : value.sixty_minute_fire_size.toString())
