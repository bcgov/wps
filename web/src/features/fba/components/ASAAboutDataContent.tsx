...
export const ASAAboutDataContent = ({ advisoryThreshold }: ASAAboutDataProps) => (
  <>
    <ul style={{ margin: 0 }}>
      ...
      <br />
      <li>
        The fuel types chosen for the text bulletin are the three most common fuel types in a zone that meet or exceed
        the Fire Behaviour Advisory threshold of 4,000 kW/m.
      </li>
    </ul>
  </>
)
