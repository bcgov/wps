        ...
        <Box sx={{display: 'flex', flexDirection: 'column'}}>
          <Box sx={{display: 'flex', flexDirection: 'row', pt: theme.spacing(2)}}>
            <Box sx={{display: 'flex', flexDirection: 'column', flexGrow: 1, pb: theme.spacing(4)}}>
              <Typography sx={{pb: theme.spacing(2)}} variant='body1'>Temperature (°C) </Typography>
              <Box sx={{display: 'flex', flexDirection: 'row', flexGrow: 1}}>
                <TextField
                  ...
                  onChange={(event: React.ChangeEvent<HTMLInputElement>) => handleFormUpdate("tempMin", parseFloat(event.target.value))}
                ...
                <TextField
                  ...
                  onChange={(event: React.ChangeEvent<HTMLInputElement>) => handleFormUpdate("tempPreferred", parseFloat(event.target.value))}
                  sx={{pr: theme.spacing(2)}}
                />
                <TextField
                  label="Maximum"
                  ...
                  onChange={(event: React.ChangeEvent<HTMLInputElement>) => handleFormUpdate("tempMax", parseFloat(event.target.value))}
                />
              </Box>
            </Box>
          </Box>
          <Box sx={{display: 'flex', flexDirection: 'column', flexGrow: 1, pb: theme.spacing(4)}}>
            <Typography sx={{pb: theme.spacing(2)}} variant='body1'>Relative Humidity (%) </Typography>
            <Box sx={{display: 'flex', flexDirection: 'row', flexGrow: 1}}>
              <TextField
                label="Minimum"
                size="small"
                ...
                onChange={(event: React.ChangeEvent<HTMLInputElement>) => handleFormUpdate("rhMin", parseFloat(event.target.value))}
                sx={{pr: theme.spacing(2)}}
              />
              <TextField
                label="Preferred"
                ...
                onChange={(event: React.ChangeEvent<HTMLInputElement>) => handleFormUpdate("rhPreferred", parseFloat(event.target.value))}
                sx={{pr: theme.spacing(2)}}
              />
              <TextField
                label="Maximum"
                ...
                onChange={(event: React.ChangeEvent<HTMLInputElement>) => handleFormUpdate("rhMax", parseFloat(event.target.value))}
              />
            </Box>
          </Box>
          <Box sx={{display: 'flex', flexDirection: 'column', flexGrow: 1, pb: theme.spacing(2)}}>
            <Typography sx={{pb: theme.spacing(2)}} variant='body1'>Wind Speed (km/h) </Typography>
            <Box sx={{display: 'flex', flexDirection: 'row', flexGrow: 1}}>
              <TextField
                label="Minimum"
                size="small"
                ...
                onChange={(event: React.ChangeEvent<HTMLInputElement>) => handleFormUpdate("windSpeedMin", parseFloat(event.target.value))}
                sx={{pr: theme.spacing(2)}}
              />
              <TextField
                label="Preferred"
                ...
                onChange={(event: React.ChangeEvent<HTMLInputElement>) => handleFormUpdate("windSpeedPreferred", parseFloat(event.target.value))}
                sx={{pr: theme.spacing(2)}}
              />
              <TextField
                label="Maximum"
                ...
                onChange={(event: React.ChangeEvent<HTMLInputElement>) => handleFormUpdate("windSpeedMax", parseFloat(event.target.value))}
              />
            </Box>
          </Box>
        </Box>
