        ...
        <Box sx={{display: 'flex', flexDirection: 'column'}}>
          <Box sx={{display: 'flex', flexDirection: 'row', pt: theme.spacing(2)}}>
            <Box sx={{display: 'flex', flexDirection: 'column', flexGrow: 1, pb: theme.spacing(4)}}>
              <Typography sx={{pb: theme.spacing(2)}} variant='body1'>Initial Spread Index (ISI) </Typography>
              <Box sx={{display: 'flex', flexDirection: 'row', flexGrow: 1}}>
                <TextField
                  ...
                  onChange={(event: React.ChangeEvent<HTMLInputElement>) => handleFormUpdate("isiMin", parseFloat(event.target.value))}
                ...
                <TextField
                  ...
                  onChange={(event: React.ChangeEvent<HTMLInputElement>) => handleFormUpdate("isiPreferred", parseFloat(event.target.value))}
                  sx={{pr: theme.spacing(2)}}
                />
                <TextField
                  label="Maximum"
                  ...
                  onChange={(event: React.ChangeEvent<HTMLInputElement>) => handleFormUpdate("isiMax", parseFloat(event.target.value))}
                />
              </Box>
            </Box>
          </Box>
          <Box sx={{display: 'flex', flexDirection: 'column', flexGrow: 1, pb: theme.spacing(4)}}>
            <Typography sx={{pb: theme.spacing(2)}} variant='body1'>Buildup Index (BUI) </Typography>
            <Box sx={{display: 'flex', flexDirection: 'row', flexGrow: 1}}>
              <TextField
                label="Minimum"
                size="small"
                ...
                onChange={(event: React.ChangeEvent<HTMLInputElement>) => handleFormUpdate("buiMin", parseFloat(event.target.value))}
                sx={{pr: theme.spacing(2)}}
              />
              <TextField
                label="Preferred"
                ...
                onChange={(event: React.ChangeEvent<HTMLInputElement>) => handleFormUpdate("buiPreferred", parseFloat(event.target.value))}
                sx={{pr: theme.spacing(2)}}
              />
              <TextField
                label="Maximum"
                ...
                onChange={(event: React.ChangeEvent<HTMLInputElement>) => handleFormUpdate("buiMax", parseFloat(event.target.value))}
              />
            </Box>
          </Box>
          <Box sx={{display: 'flex', flexDirection: 'column', flexGrow: 1, pb: theme.spacing(2)}}>
            <Typography sx={{pb: theme.spacing(2)}} variant='body1'>Head Fire Intensity (HFI) </Typography>
            <Box sx={{display: 'flex', flexDirection: 'row', flexGrow: 1}}>
              <TextField
                label="Minimum"
                size="small"
                ...
                onChange={(event: React.ChangeEvent<HTMLInputElement>) => handleFormUpdate("hfiMin", parseFloat(event.target.value))}
                sx={{pr: theme.spacing(2)}}
              />
              <TextField
                label="Preferred"
                ...
                onChange={(event: React.ChangeEvent<HTMLInputElement>) => handleFormUpdate("hfiPreferred", parseFloat(event.target.value))}
                sx={{pr: theme.spacing(2)}}
              />
              <TextField
                label="Maximum"
                ...
                onChange={(event: React.ChangeEvent<HTMLInputElement>) => handleFormUpdate("hfiMax", parseFloat(event.target.value))}
              />
            </Box>
          </Box>
        </Box>
