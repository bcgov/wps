...
const marshalFireWatchOutputToFireWatch = (fireWatchOutput: FireWatchOutput): FireWatch => {
  return {
    ...
    tempPreferred: fireWatchOutput.temp_preferred ?? undefined,
    tempMax: fireWatchOutput.temp_max,
    rhMin: fireWatchOutput.rh_min,
    rhPreferred: fireWatchOutput.rh_preferred ?? undefined,
    rhMax: fireWatchOutput.rh_max,
    windSpeedMin: fireWatchOutput.wind_speed_min,
    windSpeedPreferred: fireWatchOutput.wind_speed_preferred ?? undefined,
    windSpeedMax: fireWatchOutput.wind_speed_max,
    ffmcMin: fireWatchOutput.ffmc_min ?? undefined,
    ffmcPreferred: fireWatchOutput.ffmc_preferred ?? undefined,
    ffmcMax: fireWatchOutput.ffmc_max ?? undefined,
    dmcMin: fireWatchOutput.dmc_min ?? undefined,
    dmcPreferred: fireWatchOutput.dmc_preferred ?? undefined,
    dmcMax: fireWatchOutput.dmc_max ?? undefined,
    dcMin: fireWatchOutput.dc_min ?? undefined,
    dcPreferred: fireWatchOutput.dc_preferred ?? undefined,
    dcMax: fireWatchOutput.dc_max ?? undefined,
    isiMin: fireWatchOutput.isi_min ?? undefined,
    isiPreferred: fireWatchOutput.isi_preferred ?? undefined,
    isiMax: fireWatchOutput.isi_max ?? undefined,
    buiMin: fireWatchOutput.bui_min ?? undefined,
    buiPreferred: fireWatchOutput.bui_preferred ?? undefined,
    buiMax: fireWatchOutput.bui_max ?? undefined,
    hfiMin: fireWatchOutput.hfi_min,
    hfiPreferred: fireWatchOutput.hfi_preferred ?? undefined,
