...
export function formatWindSpeed(wind_speed: number | undefined | null): string | undefined {
...
export function formatForecastWindSpeed(wind_speed: number | undefined | null): string | undefined {
  if (typeof wind_speed === 'number') {
...
export function formatTemperature(temperature: number | undefined | null): string | undefined {
...
export function formatRelativeHumidity(relative_humidity: number | undefined | null): string | undefined {
...
export function formatPrecipitation(precipitation: number | undefined | null): string | undefined {
