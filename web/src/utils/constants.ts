...
export const PRESCRIBED_BURN_ADVISOR_ROUTE = '/prescribed-burn-advisor'
...
export const PRESCRIBED_BURN_ADVISOR_NAME = 'Prescribed Burn Advisor'
...
export const PRESCRIBED_BURN_ADVISOR_TITLE = 'Prescribed Burn Advisor | BCWS PSU'
