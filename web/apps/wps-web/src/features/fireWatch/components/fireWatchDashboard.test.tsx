...
import type { FireWatchDetailsModalProps } from '@/features/fireWatch/components/FireWatchDetailsModal'
import { BurnStatusEnum, type FireWatch, FuelTypeEnum, PrescriptionEnum } from '@/features/fireWatch/interfaces'
