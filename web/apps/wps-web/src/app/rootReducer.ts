...
import hfiCalculatorDailiesReducer, { type HFICalculatorState } from 'features/hfiCalculator/slices/hfiCalculatorSlice'
import hfiReadyReducer, { type HFIReadyState } from 'features/hfiCalculator/slices/hfiReadySlice'
...
export const selectProvincialSummaryZones = (state: RootState) => state.provincialSummary.fireShapeStatusDetails
