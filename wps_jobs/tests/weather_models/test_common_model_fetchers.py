...
def processor(mock_session):
    ...
    with patch(
        "wps_jobs.weather_model_jobs.common_model_fetchers.get_stations_synchronously",
        return_value=[],
    ):
...
@patch("wps_jobs.weather_model_jobs.common_model_fetchers.get_weather_station_model_prediction")
@patch("wps_jobs.weather_model_jobs.common_model_fetchers.WeatherStationModelPrediction")
@patch(
    "wps_jobs.weather_model_jobs.common_model_fetchers.time_utils.get_utc_now",
    return_value=datetime(2025, 6, 5, 13, 0, 0),
)
@patch("wps_jobs.weather_model_jobs.common_model_fetchers.get_accumulated_precipitation")
