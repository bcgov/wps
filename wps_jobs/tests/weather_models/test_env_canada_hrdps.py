...
from wps_shared.weather_models.job_utils import HRDPS_GRIB_LAYERS, get_high_res_model_run_download_urls
...
def mock_database(monkeypatch):
    ...
    monkeypatch.setattr(wps_jobs.weather_model_jobs.common_model_fetchers, "get_prediction_model_run_timestamp_records", mock_get_hrdps_prediction_model_run_timestamp_records)
...
def test_main_fail(mocker: MockerFixture, monkeypatch):
    ...
    rocket_chat_spy = mocker.spy(wps_jobs.weather_model_jobs.env_canada, "send_rocketchat_notification")
    monkeypatch.setattr(wps_jobs.weather_model_jobs.env_canada, "process_models", mock_process_models)
...
def test_parse_high_res_model_url_correct_format():
    ...
    for case in test_cases:
        actual_variable_name, actual_projection, actual_model_run_timestamp, actual_prediction_timestamp = wps_jobs.weather_model_jobs.env_canada.parse_high_res_model_url(
            case["url"]
        )
