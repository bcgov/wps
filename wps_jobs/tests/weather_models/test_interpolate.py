...
def generate_model_run_prediction(prediction_datetime: datetime, weather_values: float) -> ModelRunPrediction:
    model_prediction = ModelRunPrediction(
        prediction_timestamp=prediction_datetime, tmp_tgl_2=weather_values, rh_tgl_2=weather_values, apcp_sfc_0=weather_values, wind_tgl_10=weather_values, wdir_tgl_10=weather_values
    )
