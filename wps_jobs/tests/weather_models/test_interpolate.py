import pytest
from wps_jobs.weather_model_jobs.utils.interpolate import construct_interpolated_noon_prediction, SCALAR_MODEL_VALUE_KEYS_FOR_INTERPOLATION, interpolate_between_two_points, interpolate_wind_direction
...
def test_empty_wind_direction_interpolation(wdir_a, wdir_b):
    ...
    assert interpolate_wind_direction(prediction_a, prediction_b, datetime(2024, 5, 1, 18, 0, 0)) is None