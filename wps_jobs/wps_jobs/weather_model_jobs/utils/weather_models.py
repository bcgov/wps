...
from wps_jobs.weather_models.precip_model import PrecipModel
from wps_jobs.weather_models.regression_model import RegressionModelProto, model_2_actual_keys
from wps_jobs.weather_models.sample import Samples
from wps_jobs.weather_models.utils import construct_dictionary_from_list_by_property
from wps_jobs.weather_models.wind_direction_model import WindDirectionModel
...
class RegressionModelsV2:
    ...
    def __init__(self):
        ...
        self._precip_model: RegressionModelProto = PrecipModel(linear_model=LinearModel(samples=Samples()))
        ...
        for actual in actual_values:
            ...
            for daily_predicted in daily_predicted_list:
                ...
                if daily_actual is not None and not math.isnan(daily_actual) and precip_24h is not None and not math.isnan(precip_24h):
                    self._precip_model.add_sample(daily_actual, daily_predicted.precip_24h, timestamp)
