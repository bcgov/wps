"""FireCentreLabels table

Revision ID: dbe8db639a6d
Revises: 3893bbb60779
Create Date: 2022-11-23 14:25:15.901892
...
revision = 'dbe8db639a6d'
down_revision = '3893bbb60779'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_table('fire_centres_labels',
    ...
    op.create_index('idx_fire_centres_labels_geom', 'fire_centres_labels',
...
def downgrade() -> None:
    # ### commands auto generated by Alembic ###
    op.drop_index('idx_fire_centres_labels_geom', table_name='fire_centres_labels', postgresql_using='gist')
    op.drop_table('fire_centres_labels')
    # ### end Alembic commands ###
