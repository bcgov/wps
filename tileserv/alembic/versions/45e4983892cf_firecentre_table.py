...
Revision ID: 45e4983892cf
Revises: 1c0954110d4e
Create Date: 2022-11-23 14:10:50.263435
...
def upgrade() -> None:
    ...
    op.create_index('idx_fire_centre_geom', 'fire_centres', ['geom'], unique=False, postgresql_using='gist')
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('idx_fire_centre_geom', table_name='fire_centres', postgresql_using='gist')
