    ...
    stages {
        ...
        stage('Deploy (PROD)') {
            ...
            steps {
                ...
                sh "curl -X POST -H \"Content-Type: application/json\" https://chat.pathfinder.gov.bc.ca/hooks/7A8RwSpZPDAqc6uXS/z8nRXX43oifYWELkwJKeLj4e86rtyfvtJdqdvjSE3XoK2sri -d '{\"text\":\"Deployed wps-api to PROD for PR-${CHANGE_ID}.\"}'"
            }
        }
    }
}
