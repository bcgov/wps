...
class ModelRunForSFMS(Base):
    ...
    id = Column(
        Integer,
        Sequence("model_run_for_sfms_id_seq"),
        primary_key=True,
        nullable=False,
        index=True,
    )
    ...
    prediction_model_id = Column(
        Integer, ForeignKey("prediction_models.id"), nullable=False
    )
...
class PredictionModel(Base):
    ...
    id = Column(
        Integer,
        Sequence("prediction_models_id_seq"),
        primary_key=True,
        nullable=False,
        index=True,
    )
...
class PredictionModelGridSubset(Base):
    ...
    id = Column(
        Integer,
        Sequence("prediction_model_grid_subsets_id_seq"),
        primary_key=True,
        nullable=False,
        index=True,
    )
    ...
    def __str__(self):
        return (
            "id: {self.id}, " "prediction_model_id: {self.prediction_model_id}"
        ).format(self=self)
...
Index(
    ...
    PredictionModelGridSubset.geom,
...
class ModelRunGridSubsetPrediction(Base):
    ...
    id = Column(
        Integer,
        Sequence("model_run_grid_subset_predictions_id_seq"),
        primary_key=True,
        nullable=False,
        index=True,
    )
    ...
    prediction_model_run_timestamp_id = Column(
        Integer,
        ForeignKey("prediction_model_run_timestamps.id"),
        nullable=False,
        index=True,
    )
    ...
    prediction_model_grid_subset_id = Column(
        Integer,
        ForeignKey("prediction_model_grid_subsets.id"),
        nullable=False,
        index=True,
    )
