      ...
      <Table aria-label="simple table">
        <TableBody>
          <TableRow>
            ...
            <TableCell>{meanValues.ffmc.toFixed(FWI_VALUES_DECIMAL)}</TableCell>
          </TableRow>
          <TableRow>
            <TableCell>BUI mean value</TableCell>
            <TableCell>{meanValues.bui.toFixed(FWI_VALUES_DECIMAL)}</TableCell>
          </TableRow>
          <TableRow>
            <TableCell>ISI mean value</TableCell>
            <TableCell>{meanValues.isi.toFixed(FWI_VALUES_DECIMAL)}</TableCell>
          </TableRow>
        </TableBody>
      </Table>
    </TableContainer>
