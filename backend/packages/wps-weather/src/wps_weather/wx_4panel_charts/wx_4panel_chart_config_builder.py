...
class ConfigBuilder:
    ...
    def build_config_for_hour(self, fh: int):
        ...
        cfg500["z500_grib"] = self.raster_addresser.get_grib_key(
            fh,
            rdps_fname(self.init_ymd, self.init_hh, "GeopotentialHeight", "IsbL-0500", fh),
        )
        cfg500["vort_grib"] = self.raster_addresser.get_grib_key(
            fh,
            rdps_fname(self.init_ymd, self.init_hh, "AbsoluteVorticity", "IsbL-0500", fh),
        )
        ...
        cfgmslp["mslp_grib"] = self.raster_addresser.get_grib_key(
            fh,
            rdps_fname(self.init_ymd, self.init_hh, "Pressure_MSL", None, fh),
        )
        cfgmslp["thk_grib"] = self.raster_addresser.get_grib_key(
            fh,
            rdps_fname(self.init_ymd, self.init_hh, "Thickness", "IsbL-1000to0500", fh),
        )
        ...
        cfg700["z700_grib"] = self.raster_addresser.get_grib_key(
            fh,
            rdps_fname(self.init_ymd, self.init_hh, "GeopotentialHeight", "IsbL-0700", fh),
        )
        cfg700["rh500_grib"] = self.raster_addresser.get_grib_key(
            fh,
            rdps_fname(self.init_ymd, self.init_hh, "RelativeHumidity", "IsbL-0500", fh),
        )
        cfg700["rh700_grib"] = self.raster_addresser.get_grib_key(
            fh,
            rdps_fname(self.init_ymd, self.init_hh, "RelativeHumidity", "IsbL-0700", fh),
        )
        cfg700["rh850_grib"] = self.raster_addresser.get_grib_key(
            fh,
            rdps_fname(self.init_ymd, self.init_hh, "RelativeHumidity", "IsbL-0850", fh),
        )
        ...
        cfgpcpn["jet_spd_grib"] = self.raster_addresser.get_grib_key(
            fh,
            rdps_fname(self.init_ymd, self.init_hh, "WindSpeed", "IsbL-0250", fh),
        )
        ...
        if fh == 0:
            ...
            cfgpcpn["pcpn_grib"] = self.raster_addresser.get_grib_key(
                fh,
                rdps_fname(self.init_ymd, self.init_hh, "Precip-Accum3h", "Sfc", fh),
            )
