...
def build_tri_projected_safe(
    ...
    Returns (triangulation, values_1d).
    """
...
def plot_700hpa_rdps(
    ...
    lon2 = normalize_lon_to_extent(ds_z700["longitude"].values, extent)
    # Optional smoothing
    ...
    ax.tricontour(triZ, vZ, levels=hlev, colors="black", linewidths=1.0, zorder=5)
    ax.tricontour(triZ, vZ, levels=cfg["height_highlight"], colors="black", linewidths=2.0, zorder=6)
