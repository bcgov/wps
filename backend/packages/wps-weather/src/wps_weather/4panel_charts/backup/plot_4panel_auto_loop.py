# -*- coding: utf-8 -*-
"""
Generate a 2x2 4-panel plot for MANY forecast hours (12-hourly out to 10 days).

What this revision adds:
- build_cfgs_for_fh() already builds file paths for a given init + fh
- batch loop: fh = 0..240 every 12h (10 days)
- auto valid_time_str from init time + fh (UTC), injected into cfg500
- robust skipping if some files are missing
- closes figures each iteration (prevents memory leak)
