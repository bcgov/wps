...
from weather_model_jobs.utils.regression_model import RegressionModel
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (HourlyActual(weather_date=datetime(2020, 10, 10, 18)), ModelRunPrediction(), 0),
    ],
)
def test_regression_model_sample_calls(mocker: MockerFixture, actual, prediction, call_count):
    ...
    regression_model = RegressionModel(
        model_key=ModelRunPrediction.tmp_tgl_2.name, linear_model=mock_linear_model
    )
