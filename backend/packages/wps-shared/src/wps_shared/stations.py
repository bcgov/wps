...
weather_stations_file_path = os.path.join(dirname, "data/weather_stations.json")
...
def _set_weather_variables(
    station_properties: DetailedWeatherStationProperties, station_union: Row
):
    """
