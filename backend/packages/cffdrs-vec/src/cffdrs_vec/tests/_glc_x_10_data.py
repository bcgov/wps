...
cases, used by both test_fbp_glc_x_10.py (reads the vendored CSVs directly) and
test_fbp_glc_x_10_rasters.py (reads the equivalent GeoTIFF fixtures generated by
generate_glc_x_10_rasters.py from those same CSVs). See https://github.com/bcgov/wps/issues/4893.
...
INPUT_RASTER_NAMES = [
    "fuel_type_code", "lat", "lon", "elv", "ffmc", "bui", "ws", "wd", "gs",
    "dj", "d0", "aspect", "pc", "pdf", "cc", "gfl", "cbh", "cfl",
]
