...
async def test_c3_request_response(
    ...
    assert math.isclose(
        response.json()["stations"][0]["head_fire_intensity"], 2911.250, abs_tol=0.001
    )
    ...
    assert math.isclose(
        response.json()["stations"][0]["sixty_minute_fire_size"], 1.307, abs_tol=0.001
    )
    assert math.isclose(
        response.json()["stations"][0]["thirty_minute_fire_size"], 0.233, abs_tol=0.001
    )
