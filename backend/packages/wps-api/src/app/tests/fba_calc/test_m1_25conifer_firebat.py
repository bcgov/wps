...
async def test_m1_25conifer_request_response(
    ...
    assert math.isclose(
        response.json()["stations"][0]["head_fire_intensity"], 2269.261, abs_tol=0.001
    )
    ...
    assert math.isclose(
        response.json()["stations"][0]["sixty_minute_fire_size"], 3.634, abs_tol=0.001
    )
    assert math.isclose(
        response.json()["stations"][0]["thirty_minute_fire_size"], 0.649, abs_tol=0.001
    )
