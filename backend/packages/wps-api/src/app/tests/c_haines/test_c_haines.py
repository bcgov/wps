...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "12",
            "010",
            "https://dd.weather.gc.ca/today/model_rdps/10km/12/010/",
        ),
        (
            "HRDPS",
            "00",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            240,
            {
                "AirTemp_IsbL-0700": "https://dd.weather.gc.ca/today/model_rdps/10km/12/240/20210411T12Z_MSC_RDPS_AirTemp_IsbL-0700_RLatLon0.09_PT240H.grib2",
                "AirTemp_IsbL-0850": "https://dd.weather.gc.ca/today/model_rdps/10km/12/240/20210411T12Z_MSC_RDPS_AirTemp_IsbL-0850_RLatLon0.09_PT240H.grib2",
                "DewPointDepression_IsbL-0850": "https://dd.weather.gc.ca/today/model_rdps/10km/12/240/20210411T12Z_MSC_RDPS_DewPointDepression_IsbL-0850_RLatLon0.09_PT240H.grib2",
            },
