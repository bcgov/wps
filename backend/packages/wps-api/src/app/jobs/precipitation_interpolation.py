...
from app.sfms.precipitation_interpolation_processor import PrecipitationInterpolationProcessor

logger = logging.getLogger(__name__)


class PrecipitationInterpolationJob:
    """Job for processing precipitation interpolation."""

    async def run(self, target_date: datetime) -> None:
        """
        Run precipitation interpolation for the specified date.
        ...
        try:
            ...
            logger.info(
                "Precipitation interpolation completed successfully -- "
            ...
            logger.error("Precipitation interpolation job failed", exc_info=e)
            rc_message = ":scream: Precipitation interpolation job failed"
