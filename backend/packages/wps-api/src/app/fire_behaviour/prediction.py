...
def build_hourly_rh_dict(hourly_observations: List[WeatherReading]):
    ...
    rh_dict = {7.0: None, 8.0: None, 9.0: None, 10.0: None, 11.0: None, 12.0: None}
...
def calculate_fire_behaviour_prediction_using_cffdrs(
    ...
    wsv = cffdrs.calculate_wind_speed(
        FuelTypeEnum[fuel_type],
        ffmc=ffmc,
        bui=bui,
        ws=wind_speed,
        fmc=fmc,
    ...
    bros = cffdrs.back_rate_of_spread(
        FuelTypeEnum[fuel_type],
        ffmc=ffmc,
        bui=bui,
        wsv=wsv,
...
def calculate_fire_behaviour_prediction_using_c7b(
    latitude: float,
    longitude: float,
    elevation: float,
    ffmc: float,
...
def calculate_fire_behaviour_prediction(
    latitude: float,
    longitude: float,
    elevation: float,
    fuel_type: FuelTypeEnum,
