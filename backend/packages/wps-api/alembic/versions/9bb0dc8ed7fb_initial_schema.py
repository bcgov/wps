...
def upgrade():
    ...
    # Manually create the weather_station_model_predictions_id_seq sequence and assign it.
    op.execute(sa.text("CREATE SEQUENCE weather_station_model_predictions_id_seq"))

    op.execute(
        sa.text(
            """
            ALTER TABLE weather_station_model_predictions
            ALTER COLUMN id SET DEFAULT nextval('weather_station_model_predictions_id_seq')
            """
        )
    )
...
def downgrade():
    ...
    op.execute(sa.text("DROP SEQUENCE weather_station_model_predictions_id_seq"))
    op.drop_index(
        op.f("ix_weather_station_model_predictions_update_date"),
