...
def downgrade():
    ...
    op.drop_constraint("notification_settings_fire_shape_source_id_fkey", "notification_settings", type_="foreignkey")
    ...
    op.drop_constraint("notification_settings_device_token_id_fire_shape_source_id_key", "notification_settings", type_="unique")
    op.drop_index(
