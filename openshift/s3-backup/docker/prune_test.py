...
def file_generator():
    ...
    stamp = datetime(2020, 10, 15, 3, 0, 10, tzinfo=UTC)
...
class TestRollingPrune(unittest.TestCase):
    ...
    def __init__(self, methodName: str = ...) -> None:
        ...
        self.expected = [
            "backup/blah_wps/2021/06/blah_wps_2021-06-24_03-00-10.sql.gz",
...
class TestPrune(unittest.TestCase):
    ...
    def __init__(self, methodName: str = ...) -> None:
        ...
        super().__init__(methodName=methodName)
        self.ascending_list = [
            "backup/blah_wps/2021/10/blah_wps_2021-10-10_14-00-10.sql.gz",
        ...
        self.large_set = [
            "backup/blah_wps/2021/10/blah_wps_2021-10-21_14-00-10.sql.gz",  # 0 X
