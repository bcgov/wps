...
PROJ_TARGET=${PROJ_TARGET} MODEL=GDPS bash $(dirname ${0})/oc_provision_ec_cronjob.sh prod ${RUN_TYPE}
PROJ_TARGET=${PROJ_TARGET} MODEL=HRDPS bash $(dirname ${0})/oc_provision_ec_cronjob.sh prod ${RUN_TYPE}
PROJ_TARGET=${PROJ_TARGET} MODEL=RDPS bash $(dirname ${0})/oc_provision_ec_cronjob.sh prod ${RUN_TYPE}
