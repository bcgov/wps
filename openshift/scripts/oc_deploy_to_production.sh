...
PROJ_TARGET=${PROJ_TARGET} BUCKET=lwzrin CPU_REQUEST=75m MEMORY_REQUEST=2Gi MEMORY_LIMIT=8Gi DATA_SIZE=30Gi WAL_SIZE=10Gi bash $(dirname ${0})/oc_provision_crunchy.sh prod ${RUN_TYPE}
