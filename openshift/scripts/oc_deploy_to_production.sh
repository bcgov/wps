...
PROJ_TARGET=${PROJ_TARGET} BUCKET=lwzrin CPU_REQUEST=5 MEMORY_REQUEST=2Gi MEMORY_LIMIT=16Gi DATA_SIZE=65Gi WAL_SIZE=15Gi bash $(dirname ${0})/oc_provision_crunchy.sh prod ${RUN_TYPE}
