import type { FireZoneFuelStats, FireZoneHFIStatsDictionary } from '@/api/fbaAPI'
 ...
 */
export const filterHFIFuelStatsByArea = (fireCentreHFIFuelStats: FireZoneHFIStatsDictionary) => {
  const filteredFireZoneStats: FireZoneHFIStatsDictionary = {}
  for (const [key, value] of Object.entries(fireCentreHFIFuelStats)) {
    filteredFireZoneStats[Number.parseInt(key, 10)] = {
