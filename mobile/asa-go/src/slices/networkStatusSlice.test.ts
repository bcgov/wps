...
describe('networkStatusSlice', () => {
  describe('updateNetworkStatus', () => {
    ...
    ] as const)('sets connected=$connected when connectionType=$connectionType', ({ connectionType, connected }) => {
      const state = reducer(undefined, updateNetworkStatus({ connected: true, connectionType }))
