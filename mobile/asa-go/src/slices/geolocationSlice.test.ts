...
describe('geolocationSlice', () => {
  it('should handle setPosition', () => {
    ...
    const nextState = geolocationSlice(geolocationInitialState, setPosition(position))
  ...
  it('should handle setError', () => {
    ...
    const nextState = geolocationSlice(geolocationInitialState, setError(error))
...
describe('geolocationSlice thunks', () => {
  ...
  describe('startWatchingLocation', () => {
    ...
    it('updates position state on position update', async () => {
      ...
      let callback: (pos?: Position, err?: { message: string }) => void = () => {}
