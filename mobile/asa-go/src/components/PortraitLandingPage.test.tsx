...
describe('PortraitLandingPage', () => {
  ...
  describe('static content', () => {
    ...
    it('renders LoginActions with column direction', () => {
      ...
      expect(screen.getByTestId('login-actions')).toHaveAttribute('data-direction', 'column')
    })
  })
  ...
  describe('screen size variants', () => {
    it('renders an h4 title on XS small screens', () => {
      ...
      expect(screen.getByRole('heading', { level: 4, name: 'ASA Go' })).toBeInTheDocument()
    })
    ...
    it('renders an h2 title on tablet screens', () => {
      ...
      expect(screen.getByRole('heading', { level: 2, name: 'ASA Go' })).toBeInTheDocument()
    })
  })
})
