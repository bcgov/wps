// Style used by the local pmtiles basemap.
export const localBasemapStyle = {
  version: 8,
  sources: {
    protomaps: {
      type: 'vector',
  ...
  layers: [
    ...
    },
    {
      ...
      source: 'protomaps',
      'source-layer': 'roads',
      filter: ['all', ['!has', 'is_tunnel'], ['!has', 'is_bridge'], ['==', 'kind', 'highway'], ['!has', 'is_link']],
      paint: {
        'line-color': '#e0e0e0',
    ...
    },
    {
      ...
      paint: {
        'text-color': [
          'case',
          ['in', ['get', 'kind'], ['literal', ['beach', 'forest', 'marina', 'park', 'peak', 'zoo', 'garden', 'bench']]],
          '#20834D',
          ['in', ['get', 'kind'], ['literal', ['aerodrome', 'station', 'bus_stop', 'ferry_terminal']]],
          '#315BCF',
          [
            'in',
            ['get', 'kind'],
            ['literal', ['stadium', 'university', 'library', 'school', 'animal', 'toilets', 'drinking_water']]
          ],
          '#6A5B8F',
          '#e2dfda'
        ],
    ...
    },
    {
      ...
      layout: {
        ...
        'text-size': [
          ...
          ['zoom'],
          2,
          ['case', ['<', ['get', 'population_rank'], 10], 8, ['>=', ['get', 'population_rank'], 10], 12, 0],
          6,
          ['case', ['<', ['get', 'population_rank'], 8], 10, ['>=', ['get', 'population_rank'], 8], 18, 0],
          8,
