...
describe('SideNavigationListItem', () => {
  ...
  it('renders the component with icon and text', () => {
    render(<SideNavigationListItem icon={mockIcon} navItem={mockNavItem} tab={mockTab} setTab={mockSetTab} />)
  ...
  it('renders with selected styles when tab matches navItem', () => {
    render(<SideNavigationListItem icon={mockIcon} navItem={mockNavItem} tab={mockNavItem} setTab={mockSetTab} />)
  ...
  it('renders with default styles when tab does not match navItem', () => {
    render(<SideNavigationListItem icon={mockIcon} navItem={mockNavItem} tab={NavPanel.MAP} setTab={mockSetTab} />)
  ...
  it('renders different nav items correctly', () => {
    ...
    navItems.forEach(navItem => {
      render(<SideNavigationListItem icon={mockIcon} navItem={navItem} tab={mockTab} setTab={mockSetTab} />)
