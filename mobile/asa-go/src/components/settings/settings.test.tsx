...
describe('Settings', () => {
  ...
  it('renders offline message when offline', async () => {
    ...
    expect(await screen.findByText(/Notification settings are not available while offline/i)).toBeInTheDocument()
  })
  ...
  it('renders notification permission warning when permission is denied', async () => {
    ...
    expect(await screen.findByTestId('notifications-permission-warning')).toBeInTheDocument()
    expect(screen.getByText(/Push notifications disabled/i)).toBeInTheDocument()
  })
  ...
  it('renders notification prompt when permission is granted and online', async () => {
    ...
    expect(await screen.findByText(/Set your notification subscriptions/i)).toBeInTheDocument()
  })
  ...
  it('does not show device ID error banner when deviceIdError is false', async () => {
    ...
    await waitFor(() => {
      expect(screen.queryByTestId('device-id-error-banner')).not.toBeInTheDocument()
    })
  })
