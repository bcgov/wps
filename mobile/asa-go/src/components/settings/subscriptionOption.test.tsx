...
describe('SubscriptionOption', () => {
  ...
  const renderWithProvider = (fireZoneUnit: FireZoneUnit, initialSubscriptions: number[] = []) => {
    ...
    return {
      ...render(
        <Provider store={store}>
          <SubscriptionOption fireZoneUnit={fireZoneUnit} onToggle={onToggle} disabled={false} />
        </Provider>
      ),
      store
    }
