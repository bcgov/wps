...
const ActualForecastControl = ({
  runType,
  setRunType,
}: ActualForecastControlProps) => {
  const changeHandler = (_: React.ChangeEvent<object>, value: string) => {
    if (!isNull(value)) {
