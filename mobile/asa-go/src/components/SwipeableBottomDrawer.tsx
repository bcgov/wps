...
export const SwipeableBottomDrawer = ({ children, open, onClose }: SwipeableBottomDrawerProps) => {
      ...
      slotProps={{
        ...
        paper: {
          sx: {
            ...
            paddingBottom: useSideSheet ? theme.spacing(1) : 'env(safe-area-inset-bottom)',
            pointerEvents: 'auto',
            bottom: 0,
            height: useSideSheet ? `calc(100% - ${theme.spacing(2)})` : undefined,
